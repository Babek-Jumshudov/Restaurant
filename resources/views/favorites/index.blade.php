                ...
                <div class="container">
                    <div class="s_contain">
                        <div class="s_report" id='rest'>
                            ...
                            <p>Restaurants <b>({{ $favorites->count() }})</b></p>
                        </div>
                        <div id='dish'>
                            <i class="fa-solid fa-utensils"></i>
                            <p>Dishes <b>({{ $products->count() }})</b></p>
                        </div>
                    </div>
                        ...
                        <div class="container  grid-container">
                            ...
                            @foreach ($favorites as $favorite)
                                @foreach ($sellers as $seller)
                                    @if ($seller->id === $favorite->seller_id)
                                        <a style="
                                        width: 200px;
                                            border: 1px #00000021 dashed;
                                            border-radius: 13px;"
                                            class=" mb-3" href="{{ route('home.detals', ['seller' => $seller]) }}">
                                            <div class="featured_product_img">
                                                <form
                                                    action="{{ route('favoritSeller.delete', ['favorite' => $favorite]) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')

        ...
        <div class=" b_div_sag">
            ...
            <div class="mt-4 b_div_sag_ilkdiv">
                ...
                <span class="select">
                  ...
                  <span>
                    ...
                    <select name="cars" id="cars">
                      <option value="volvo">San Francisco, California </option>
                      <option value="volvo">San Francisco, California</option>
                      <option value="volvo">San Francisco, California</option>
                      <option value="volvo">San Francisco, California</option>
                      <option value="volvo">San Francisco, California</option>
                    ...
                    <svg style="background: white; position: relative; left: -16%;" width="16" height="16" viewBox="0 0 16 16"
                  ...
                  <span>
                    ...
                    <svg class="nav_svg_2" width="16" height="16" viewBox="0 0 16 16" fill="none"
                  ...
                  <span>
                    ...
                    <select name="cars" id="cars">
                      <option value="volvo">Best deals</option>
                      <option value="volvo">Best deals</option>
                      <option value="volvo">Best deals</option>
                      <option value="volvo">Best deals</option>
                    </select>
                ...
                <span class="buttons">
                  ...
                  <a href="#" class=" b_filter_icon"><svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <a href="#" class="b_sebet_icon"><svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="b_div_sag_products">
                <div class="container">
                    ...
                    <div>
                        <div class="b_catagories" style="display: flex;">
                            <div class="cards">
                                <div class="card_card">
                                    ...
                                    <div class="info">
                                        <b>Domino's Pizza</b>
                                        <div>
                                            <i class="fa-solid fa-star"></i> <span><b>5,0</b> (736)</span>
                                            <i class="fa-solid fa-utensils"></i> <span>Chicken</span>
                                            <i class="fa-solid fa-money-check-dollar"></i>
                                            <span>$ $</span>
                                        </div>
                                        <div class="location">
                                            <a href="" class="link">Free delivery</a>
                                            <span><i class="fa-solid fa-location-crosshairs"></i> 2,8 km</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container">
                    ...
                    <div class="cards2">
                        <div class="cards_card2">
                            <img src="https://images-gmi-pmc.edge-generalmills.com/85d24894-0491-41e7-84bd-3fddeae25d12.jpg"
                                alt="" />
                            <div class="info2">
                                <h5 class="card_title">Chicken Grill</h5>
                                <a href="" class="link">Free delivery</a>
                            </div>
                            <div class="info2">
                                <i class="fa-solid fa-star"></i> <span><b>4,5</b> (201)</span>
                                <i class="fa-solid fa-utensils"></i> <span>Chicken</span>
                                <i class="fa-solid fa-motorcycle"></i> <span>30 - 40 min</span>
                            </div>
                        </div>
                        <div class="cards_card2">
                            <img src="https://images-gmi-pmc.edge-generalmills.com/85d24894-0491-41e7-84bd-3fddeae25d12.jpg"

<div class=" b_div_sag_ilkdiv">
    ...
    <span class="select">
        ...
        <span>
            ...
            <select name="cars" class="form-control" style="border: none;" id="cars">
                <option value="elmler">Filial</option>
                <option value="elmler">Elmlər Filialı</option>
                <option value="deniz_mall">Dəniz Mall Filialı</option>
                <option value="28_mall">28 Mall Filialı</option>
                <option value="genclik_mall">Gənclik Mall Filialı</option>
                <option value="port_baku">Port Baku Filialı</option>
                <option value="nesimi">Nəsimi Filialı</option>
                <option value="nerimanov">Nərimanov Filialı</option>
            </select>
        ...
        <span>
            ...
            <select class="form-control" style="border: none" name="cars" id="cars">
                <option value="konumum">Konumum</option>
        ...
        <span>
            ...
            <select class="form-control" style="border: none" name="cars" id="cars">
                <option value="discount">Endirim Kuponunuz</option>
                <option value="discount_10">10% Endirim Kuponu</option>
                <option value="free_coffee">Pulsuz Qəhvə Kuponu</option>
                <option value="buy1_get1">1 Al 1 Hədiyyə Kuponu</option>
                <option value="birthday_special">Ad Günü Xüsusi Kuponu</option>
            </select>

        </span>
    </span>
    <!-- search -->
    <span class="form-outline b_input">
    ...
    <span class="buttons">
        ...
        <a href="#" class=" b_filter_icon"><svg viewBox="0 0 48 48" fill="none"
        ...
        <a href="<?php echo e(route('basget')); ?>" class="b_sebet_icon"><svg viewBox="0 0 48 48" fill="none"
                xmlns="http://www.w3.org/2000/svg">
...
<?php /**PATH D:\Web Proyektlerim\Final Project\resources\views/layout/navbar.blade.php ENDPATH**/ ?>
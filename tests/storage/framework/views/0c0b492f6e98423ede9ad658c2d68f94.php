    ...
    <div class="row b_sag_sol">
        ...
        <div class=" b_div_sag">
            ...
            <div class="b_div_sag_products">
                <div class="container">
                    <div class="s_contain">
                        <div class="s_report" id='rest'>
                            ...
                            <p>Restaurants <b>(<?php echo e($favorites->count()); ?>)</b></p>
                        </div>
                        <div id='dish'>
                            <i class="fa-solid fa-utensils"></i>
                            <p>Dishes <b>(<?php echo e($products->count()); ?>)</b></p>
                        </div>
                    </div>
                    <div id="prod" class="m-3">
                        <div class="container  grid-container">
                            ...
                            <?php $__currentLoopData = $favorites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $favorite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php $__currentLoopData = $sellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($seller->id === $favorite->seller_id): ?>
                                        <a style="
                                        width: 200px;
                                            border: 1px #00000021 dashed;
                                            border-radius: 13px;"
                                            class=" mb-3" href="<?php echo e(route('home.detals', ['seller' => $seller])); ?>">
                                            <div class="featured_product_img">
                                                <form
                                                    action="<?php echo e(route('favoritSeller.delete', ['favorite' => $favorite])); ?>"
                                                    method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
                                                    <button type="submit" class="btn  mr-5"
                                                        style="position: absolute;background: white;border-radius: 50%;box-shadow: -1px 0px 12px 4px #c9c9c9;"><i
                                                            class="fa-solid fa-heart-crack"
                                                            style="font-size: 25px;color: red;"></i></button>
                                                </form>
                                                <div
                                                    style="width:100%; height: 20vh; background: #F7F7F7; border-radius: 12px">
                                                    <img style="width: 80%; height: 90%; padding-left: 20%; padding-top: 5%;"
                                                        src="<?php echo e(asset($seller->image)); ?>" />
                                                </div>

                                            </div>
                                            <div class=" featured_product_location mr-5 mb-3">
                                                <p><b><?php echo e($seller->name); ?></b></p>
                                                <div class="container">
                                                    ...
                                                    <span
                                                        ...
                                                        <?php echo e($seller->star); ?>

                                                    </span>
                                                    <svg width="47" height="18" viewBox="0 0 47 18"
                ...
                <?php else: ?>
                    <h1 style="text-align: center; margin-top: 150px; color:rgba(255, 0, 0, 0.603); font-style: italic; ">
                        Favorit restoran yoxdur..
                    </h1>
                <?php endif; ?>
                        ...
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="asian_box col-4">
                                ...
                                <div style="display: flex;justify-content: space-around; align-items: baseline;">
                                    <p style="font-size: 15px;"><?php echo e($product->name); ?></p>
                                    <span
                                        style=" font-size: 10px; color: #503e9d;  border-radius: 5px;  position: relative; padding: 4px;  background: #eeecf6;">
                                        <?php echo e($product->delivery); ?>
...
<?php /**PATH D:\Web Proyektlerim\Final Project\resources\views/favorites/index.blade.php ENDPATH**/ ?>
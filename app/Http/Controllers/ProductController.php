...
class ProductController extends Controller
{
    ...
    {
        $favorites = Favorites::orderBy("created_at", "desc")->paginate(20);
        $basgets = Basget::orderBy("created_at", "desc")->paginate(30);
        $products = Product::orderBy("created_at", "desc")->paginate(20);
        $sellers = Seller::orderBy("created_at", "desc")->paginate(20);
        return view('favorites.index',  compact('products', 'sellers', 'basgets', 'favorites'));
    }
    ...
    public function detals(Seller $seller)
    {
        ...
        $basgets = Basget::orderBy("created_at", "desc")->paginate(30);
        $products = Product::orderBy("created_at", "desc")->paginate(20);
        return view('home.detals', ['seller' => $seller] , compact('products' , 'basgets', 'favorites' ));
    }
